...
|---|---|---|
| 2.0 Recherche | [Best Practices Summary — Pages](phase-2/2.0-best-practices-pages.md) | ⏳ **En attente de validation HITL** |
| 2.1 Conception des pages (une à la fois) | Spécification par page (~14 lots, ordre proposé en 2.0 §6) | À venir |
...
1. **Validation HITL du livrable 2.0 Best Practices — Pages** ← nous sommes ici
2. Étape 2.1 — Spécification page par page (démarrage : Accueil)
