...
| 6.1 Développement | Lot 1 [Socle données](phase-6/6.1-backend/lot-1-socle-donnees.md) ⏳ **en attente de validation (P34)** · Lot 2 (auth + Ma liste sync) · Lot 3 (ingestion vidéo D7/D8) · Lot 4 (formulaires H77) | En cours |
