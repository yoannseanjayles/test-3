...
| **Sous-étape en cours** | 2.1 Conception des pages — 2/14 validées, page 3/14 (Fiche Série) rédigée, **en attente de validation HITL** |
| **Dernier livrable** | [Spécification Fiche Série](phase-2/2.1-pages/fiche-serie.md) |
