...
> **Suivi (2026-07-17, P44)** : lot d'amélioration complète appliqué — ✅ A5 (page Personne `/personne/{slug}`, explorateur d'épisodes, /tendances devient une vraie page), A7 (recherche instantanée `/api/recherche`), B5 partiel (raccourcis clavier, ±10 s, vitesse — sous-titres restent hors périmètre H73). Restent ouverts : §0/E3 (vérification live — clés commanditaire), B6 partiel (logo), D2 (arbitrage juridique), D4, E1, E2 → lots C1/C5.
