...
- 6.1 — Développement : [Lot 1 — Socle données](docs/phase-6/6.1-backend/lot-1-socle-donnees.md) ✅ *(D34)* · [Lot 2 — Comptes & synchro](docs/phase-6/6.1-backend/lot-2-comptes-synchro.md) ⏳ *(en attente de validation HITL — P35)*
