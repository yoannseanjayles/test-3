...
- 5.1 — Déploiement : [Déploiement Vercel](docs/phase-5/5.1-frontend/deploiement-vercel.md) ⏳ *(build/lint validés — rattachement du dépôt à Vercel à effectuer, Root Directory = `app`)*
