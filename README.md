...
- 2.1 — Spécifications de pages : [Accueil](docs/phase-2/2.1-pages/accueil.md) ✅ · [Fiche Film](docs/phase-2/2.1-pages/fiche-film.md) ✅ · [Fiche Série](docs/phase-2/2.1-pages/fiche-serie.md) ⏳ *(3/14, en attente de validation HITL)*
